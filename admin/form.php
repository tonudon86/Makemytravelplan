            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-desktop"></i>Domestic</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                               ...
                               <li>								
                                    <a href="himalayan.php">Himalayan</a>
                                </li>
						...
						<li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-desktop"></i>International</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="./upload.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">Upload Image</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="hidden" name="MAX_FILE_SIZE" value="512000" />
                                                    <span class="help-block">Top Banner Image</span>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Main Banner</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    Image  to be uploaded: <input name="userfile" type="file" />
                                                    <span class="help-block">Upload Now</span>
                                                </div>
                                            </div>
                                        </div>
                                    <div class="card-footer">
