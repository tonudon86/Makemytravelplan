      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Home</a></span> <span>Europe</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Europe Packages</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-sm col-md-12 col-lg-4 ftco-animate">
				        <div class="destination">
		    					<a href="europedreams.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/destination-3.jpg);"> 								        
		    						<div class="icon d-flex justify-content-center align-items-center">
									     Learn More
		    						</div>
                                            <div class="up"> <h4>Europe Dreams</h4> 
											<span id="day">11 Days</span>
											<span id="night">10 Nights</span>
											<li>Daily Breakfast & Dinner</li>
											<li>Visit - France,Belgium,Holland,Germany,Austria</li>
											<li>Accommodation in Double Room</li>
											<li>Visa+Medical+Sightseeing+Transfer By Coach</li>
											<li>Return Flight Ex Delhi-Paris & MIlan-Delhi</li>
										    </div>				   
								</a> 			    										
		    			...
		    			<div class="col-sm col-md-12 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="easteurope.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/switzerland.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							Learn More
		    						</div>
									 <div class="up"> <h4>Eastern Europe</h4> 
											<span id="day">8 Days</span>
											<span id="night">7 Nights</span>
											<li>Daily Breakfast & Dinner</li>
											<li>Visit - Germany,Prague,Slovakia,Hungary,Austria</li>
											<li>Visa+Medical+Sightseeing+Transfer By Coach</li>
											<li>Return Flight Ex Delhi-Munich-Delhi</li>
											 </div>		
		    					</a>
		    			...
		    			<div class="col-sm col-md-12 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="besteurope.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/image_1.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							Learn More
		    						</div>
									<div class="up"> <h4>Best Europe+London</h4> 
											<span id="day">10 Days</span>
											<span id="night">9 Nights</span>
											<li>Daily Breakfast & Dinner</li>
											<li>Visit - London,France,Switzerland,Germany</li>
											<li>Accommodation in Double Room</li>
											<li>Visa+Medical+Sightseeing+Transfer By Coach</li>
											<li>Return Flight Ex Delhi-London & Zurich-Delhi</li>
										    </div>		
		    					</a>
		    				</div>
		    			</div>
