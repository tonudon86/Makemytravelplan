      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Dubai 3Star</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/dub2.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/dub3.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/dub2.jpeg);"></div>
          				</div>
          			</div>
          		</div>
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="dubai1.html" class="img img-2" style="background-image: url(images/dub5.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="dubai1.html">4*Delux Hotel Dubai Tour</a></h3>
						    						<p class="rate">
