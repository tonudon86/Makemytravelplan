        ...
        <div class="row">
        	    <?=$cont?>
					<div class="sidebar-wrap ftco-animate">
						<h3 class="heading mb-4"><b>Rs.1,15000/-</b></h3>
					<div>
						<label>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Germany</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Czech Republic</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Slovakia, Hungary</i></li>
