      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Europe Dreams</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
        	    <?=$cont?>
					<div class="sidebar-wrap ftco-animate">
						<h3 class="heading mb-4"><b>Rs.1,49990/-</b></h3>
					<div>
						<label>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>France</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Belgium</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Holland</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Germany</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Switzerland</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Austria</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Italy</i></li>
							<li style="inline-style:none;"><i class="fa fa-plane" aria-hidden="true"></i>Vatican City</i></li>
						</label>
				</div>
			</div>
          </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/dub1.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/dub3.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/dub5.jpg);"></div>
          				</div>
          			</div>
          		</div>
