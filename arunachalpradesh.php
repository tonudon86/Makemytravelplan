...
<html lang="en">
  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/ArunachalPradesh2.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Home</a></span> <span>Arunachal Pradesh</span></p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Arunachal Pradesh</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-sm col-md-12 col-lg-4 ftco-animate">
				        <div class="destination">
		    					<a href="arunachalpradesh1.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/ArunachalPradesh1.jpg);"> 								        
		    						<div class="icon d-flex justify-content-center align-items-center">
									     Learn More
		    						</div>
                                            <div class="up"> <h4> Arunachal Monastic Tour</h4> 
											<span id="day">8 Days</span>
											<span id="night">7 Nights</span>
											<li><b>Day 01:</b> Guwahati – Bhalukpong</li>
											<li><b>Day 02:</b>Bhalukpong – Dirang</li>
											<li><b>Day 03:</b>Dirang – Tawang</li>
											<li><b>Day 04:</b> Tawang</li>
											<li><b>Day 05:</b> Tawang - Bomdila</li>
											<li><b>Day 06:</b> Bomdila – Tezpur</li>
											<li><b> Click for full </b></li>
		    			...
		    			<div class="col-sm col-md-12 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="arunachalpradesh2.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/ArunachalPradesh2.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							Learn More
		    						</div>
									<div class="up"> <h4> Eastern Arunachal Tour</h4> 
											<span id="day">10 Days</span>
											<span id="night">9 Nights</span>
		    			...
		    			<div class="col-sm col-md-12 col-lg-4 ftco-animate">
		    				<div class="destination">
		    					<a href="arunachalpradesh3.php" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/ArunachalPradesh3.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							Learn More
		    						</div>
									<div class="up"> <h4> ANortheast Wildlife Tour</h4> 
											<span id="day">11 Days</span>
											<span id="night">10 Nights</span>
