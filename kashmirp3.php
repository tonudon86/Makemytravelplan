      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Kashmir</h1>
          </div>
        </div>
      </div>
    </div>
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/kashmir.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/kashmir1.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="hotel-img" style="background-image: url(images/kashmir2.jpeg);"></div>
          				</div>
          			</div>
          		</div>
          			...
          			<p class="rate mb-5">
          				<span class="loc"><a href="#"><i class="icon-map"></i>6 Days/5 Nights</a></span>
    						...
    						<div class="d-md-flex mt-5 mb-5">
    							<ul>
	    							<li><b>Day 01:</b>Srinagar to Pahalgam</li>
	    							<li>Pick up from Srinagar airport and proceed to Pahalgam, check-in at the hotel and spend the rest of the day at leisure. Overnight stay at the hotel in Pahalgam</li>
	    							<li><b>Day 02:</b>at Pahalgam</li>
									<li>After breakfast. Local Sightseeing in Pahalgam. Like Chandanwari, Betab Valley also visits Aru Valley ( at your own) and Overnight stay at Hotel. </li>
									<li><b>Day 03:</b> Pahalgam to Srinagar</li>
									<li>After Breakfast proceeds to Srinagar, on arrival check in at Hotel later Visit Srinagar half day tour of world famous Mughal Gardens visiting the Nishat Bagh (The garden of pleasure) and Shalimar Bagh (Adobe of love), Shankaracharya Temple, Pari Mahal, Hazratbal ShrineOvernight Stay in the Hotel.</li>
									<li><b>Day 04:</b> Srinagar - Sonamarg – Srinagar.</li>
									<li>After breakfasts proceed to full day excursion of Sonamarg which is one of the most beautiful drives from Srinagar. Sonamarg also called Meadows of Gold is located at a height of 2692 meters. You may take a pony ride (at your own cost) to Thajiwas Glacier where snow remains round the year. Evening Back to Srinagar. Overnight Stay in the hotel.</li>
									<li><b>Day 05:</b>Srinagar - Gulmarg - Srinagar</li>
									<li>In the morning after breakfast, is scheduled for a day visit to Gulmarg. The road from Srinagar to Gulmarg via Tangmarg is an extremely mesmerizing one. The snow-clad mountains and the mauve and white flower grew on the side of the road offer a soothing sight to the eyes. As you reach Gulmarg, you are free to spend doing in the activities of your interest. Enjoy leisure walks or enjoy a ride in the worlds second-highest Gondola ride ( at your own cost) in Gulmarg up to Khilanmarg. The view from the top is even more enchanting. Back to Srinagar in the evening, overnight in Houseboat.</li>
									<li><b>Day 06:</b>Srinagar - Drop</li>
									<li>After breakfast check out and drop at the airport</li>
									<li><b>Inclusion</b></li>
									<li>Sightseeing as per the itinerary
										...
										All Transport & Hotels Related Taxes</li>
	    						</ul>
          			...
          			<div class="row">
          				<div class="col-md-4">
				    				<div class="destination">
				    					<a href="hotel-single.html" class="img img-2" style="background-image: url(images/kashmir1.jpg);"></a>
				    					<div class="text p-3">
				    						<div class="d-flex">
				    							<div class="one">
						    						<h3><a href="kashmirp2.html">Kashmir Tour Package-2</a></h3>
						    						<p class="rate">
