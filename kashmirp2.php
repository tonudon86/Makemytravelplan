      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span><a href="kashmir.php"></a>Package-2
			</a></span></p>
            <h1  ahref="kashmir.html" class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Kashmir</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-9">
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div a href="kashmir.html" class="single-slider owl-carousel">
          				<div class="item">
